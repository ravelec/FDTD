...
// number of time steps
    ...
    // reat 3d structures such as bricks and spheres
    ...
    //pecs quantity
    const int pec_num =3;
    float pec_min_x[pec_num];
    float pec_min_y[pec_num];
    float pec_min_z[pec_num];
    float pec_max_x[pec_num];
    float pec_max_y[pec_num];
    float pec_max_z[pec_num];
    float pec_sigma_e_x[pec_num];
    float pec_sigma_e_y[pec_num];
    float pec_sigma_e_z[pec_num];
    int pec_opt;
    ...
    //Create Resistors
    float resistor_min_x;
    float resistor_min_y;
    float resistor_min_z;
    float resistor_max_x;
    float resistor_max_y;
    float resistor_max_z;
